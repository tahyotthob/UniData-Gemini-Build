...
const features = [
  ...
  },
  {
    ...
    details: ["University Targeting", "Profile Matching", "Niche Group Access"],
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-12">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 p-4 rounded-xl text-center backdrop-blur-sm border border-white/5">
                ...
                <p className="text-xs opacity-70">Data in Transit</p>
              </div>
              <div className="bg-white/10 p-4 rounded-xl text-center backdrop-blur-sm border border-white/5">
                <p className="text-2xl font-bold">Private</p>
                <p className="text-xs opacity-70">Respondent Data</p>
              </div>
            </div>
          </div>
        </div>
