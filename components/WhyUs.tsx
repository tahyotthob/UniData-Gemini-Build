  ...
  const points = [
    {
      ...
      desc: "No more bot responses. We use profile validation and academic email checks to ensure your data comes from real people.",
      icon: (
            ...
            <div className="bg-unidata-blue rounded-3xl p-8 text-white relative z-10">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-unidata-green">High</span>
                </div>
                <div className="w-full bg-white/10 h-2 rounded-full overflow-hidden">
